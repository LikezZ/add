...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		LuaMonoBehaviourWrap.Register(L);
		LuaEngineSystemWrap.Register(L);
		UIEventTriggerWrap.Register(L);
		UIResizeWrap.Register(L);
		LuaObjectBehaviourWrap.Register(L);
		LuaColliderBehaviourWrap.Register(L);
		ScriptHelperWrap.Register(L);
