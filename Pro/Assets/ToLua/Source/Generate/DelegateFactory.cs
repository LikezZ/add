...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(UIEventTrigger.VoidDelegate), UIEventTrigger_VoidDelegate);
		dict.Add(typeof(UIEventTrigger.VectorDelegate), UIEventTrigger_VectorDelegate);
		dict.Add(typeof(UIEventTrigger.PointerEventDataDelegate), UIEventTrigger_PointerEventDataDelegate);
	...
	class UIEventTrigger_VoidDelegate_Event : LuaDelegate
	{
		public UIEventTrigger_VoidDelegate_Event(LuaFunction func) : base(func) { }
		public UIEventTrigger_VoidDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate UIEventTrigger_VoidDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UIEventTrigger.VoidDelegate fn = delegate(UnityEngine.GameObject param0) { };
			return fn;
		}

		if(!flag)
		{
			UIEventTrigger_VoidDelegate_Event target = new UIEventTrigger_VoidDelegate_Event(func);
			UIEventTrigger.VoidDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UIEventTrigger_VoidDelegate_Event target = new UIEventTrigger_VoidDelegate_Event(func, self);
			UIEventTrigger.VoidDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class UIEventTrigger_VectorDelegate_Event : LuaDelegate
	{
		public UIEventTrigger_VectorDelegate_Event(LuaFunction func) : base(func) { }
		public UIEventTrigger_VectorDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate UIEventTrigger_VectorDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UIEventTrigger.VectorDelegate fn = delegate(UnityEngine.Vector2 param0) { };
			return fn;
		}

		if(!flag)
		{
			UIEventTrigger_VectorDelegate_Event target = new UIEventTrigger_VectorDelegate_Event(func);
			UIEventTrigger.VectorDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UIEventTrigger_VectorDelegate_Event target = new UIEventTrigger_VectorDelegate_Event(func, self);
			UIEventTrigger.VectorDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	class UIEventTrigger_PointerEventDataDelegate_Event : LuaDelegate
	{
		public UIEventTrigger_PointerEventDataDelegate_Event(LuaFunction func) : base(func) { }
		public UIEventTrigger_PointerEventDataDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate UIEventTrigger_PointerEventDataDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UIEventTrigger.PointerEventDataDelegate fn = delegate(UnityEngine.EventSystems.PointerEventData param0) { };
			return fn;
		}

		if(!flag)
		{
			UIEventTrigger_PointerEventDataDelegate_Event target = new UIEventTrigger_PointerEventDataDelegate_Event(func);
			UIEventTrigger.PointerEventDataDelegate d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UIEventTrigger_PointerEventDataDelegate_Event target = new UIEventTrigger_PointerEventDataDelegate_Event(func, self);
			UIEventTrigger.PointerEventDataDelegate d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
